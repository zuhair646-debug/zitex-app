...
- iOS: v1.4.1 (build 21) — Building ⏳ + auto-submit script running
- Android: v1.4.1 (versionCode 22) — Building ⏳ + auto-submit script running
- v1.4.0: iOS build 20 ✅ Submitted to TestFlight | Android vc 21 ✅ Submitted to Play Internal (2026-09-01)
- v1.3.7: All shipped ✅
- v1.3.2: All shipped ✅
