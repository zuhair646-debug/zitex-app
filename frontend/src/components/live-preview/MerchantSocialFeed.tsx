...
const s = StyleSheet.create({
  ...
  // Card matches customer feed — LUXE DARK theme for merchant view
  postCard: { marginHorizontal: 20, marginBottom: 16, backgroundColor: LP.CARD, borderRadius: 20, padding: 16, position: 'relative', borderWidth: 1, borderColor: LP.BORDER },
  ...
  qBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: LP.WARN + '25', borderWidth: 1, borderColor: LP.WARN + '55', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4, alignSelf: 'flex-start', marginBottom: 8 },
  qBadgeText: { fontSize: 11, color: LP.WARN, fontWeight: '700' },
  postHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 10, marginTop: 24 },
  postAvatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: LP.GOLD + '25', alignItems: 'center', justifyContent: 'center', marginEnd: 10 },
  postAuthorInfo: { flex: 1 },
  postAuthor: { fontSize: 14, fontWeight: '700', color: LP.TEXT },
  postTime: { fontSize: 11, color: LP.MUTED },
  postViews: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  viewsText: { fontSize: 11, color: LP.MUTED },
  postText: { fontSize: 14, color: LP.TEXT, lineHeight: 22, marginBottom: 12 },
  ...
  eventBox: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: LP.SUCCESS + '25', borderWidth: 1, borderColor: LP.SUCCESS + '50', padding: 10, borderRadius: 10, marginBottom: 10 },
  eventText: { fontSize: 12, color: LP.SUCCESS, fontWeight: '700' },
  pollOption: { flexDirection: 'row', alignItems: 'center', height: 44, borderRadius: 12, overflow: 'hidden', backgroundColor: LP.CARD_2, borderWidth: 1, borderColor: LP.BORDER, paddingHorizontal: 14, marginBottom: 6 },
  pollSelected: { borderColor: LP.GOLD, borderWidth: 2 },
  pollBarFill: { position: 'absolute', left: 0, top: 0, bottom: 0, backgroundColor: LP.GOLD + '30' },
  pollOptionText: { flex: 1, fontSize: 13, fontWeight: '600', color: LP.TEXT, zIndex: 1 },
  pollPct: { fontSize: 13, fontWeight: '700', color: LP.GOLD, zIndex: 1 },
  totalVotesText: { fontSize: 11, color: LP.MUTED, textAlign: 'center', marginBottom: 8 },
  postActions: { flexDirection: 'row', gap: 16, paddingTop: 4, alignItems: 'center' },
  actionItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  actionCount: { fontSize: 12, color: LP.MUTED, fontWeight: '500' },
